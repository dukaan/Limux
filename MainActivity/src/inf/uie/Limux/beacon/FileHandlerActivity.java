...
public class FileHandlerActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.beacon_activity_filelist);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    ...
	    inflater.inflate(R.menu.beacon_listfiles_activity_actions, menu);
	    return true;
	}
	...
	private void refreshFileList() {
	    ...
	    listView.setAdapter(new ArrayAdapter<String>(this, R.layout.beacon_file_list_item, list));
